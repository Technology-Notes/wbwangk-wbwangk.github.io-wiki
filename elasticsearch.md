...
[Playing HTTP Tricks with Nginx](https://www.elastic.co/blog/playing-http-tricks-nginx)是一篇elasticsearch官方博客文章，介绍了利用Nginx加强elasticsearch的功能，包括：
- http连接池。减少反复创建http连接的开销。
- 负载均衡
- 基础认证和授权
- 使用nginx的lua插件实现ACL
